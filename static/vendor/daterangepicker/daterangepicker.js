    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                var maxYear = (maxDate && maxDate.year()) || (currentYear + 1);
            ...
            // $('.yearselect option:not(:selected)').hide();
            $(document).ready(function() {
                ...
                $('.monthselect option').each(function() {
                    var yearValue = parseInt($('.yearselect').val());
                    var monthValue = parseInt($(this).val());
                  ...
                  $('table td').each(function() {
                    ...
                    var selectedText = parseInt($(this).text());
                    selectedText+=1
                    // console.log(selectedText);
                    if (monthValue == currentMonth && yearValue == currentYear) {
                        $(this).attr('disabled', true);
                        $(this).removeAttr('class');
                        if ( selectedText == currentDay){
                            return false; 
                             }
                ...
                $('table i').hide();
                  $('th').removeClass('next available');
                    $('th').removeClass('prev available');
              });
